...
def main():
    torchvision.datasets.CIFAR100.url="https://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz"
    ...
    PATH = os.path.join(script_dir, "net_100.pth");
    ...
    correct_pred = {classname: 0 for classname in range(100)}  # CIFAR-100 has 100 classes
