...
public class Sample16BitALUTest {
  ...
  public void testNot() {
    verifyLogic("not", OpCodes.NOT, 0x0001, 0x0F0F, (a, b) -> (~a) & 0xFFFF);
  }

  @Test
  public void testXor() {
    verifyLogic("xor", OpCodes.XOR, 0xF32c, 0x3902, (a, b) -> a ^ b);
  }

  @Test
  public void testOr() {
    verifyLogic("or", OpCodes.OR, 0xFF01, 0x0Fca, (a, b) -> a | b);
  }
