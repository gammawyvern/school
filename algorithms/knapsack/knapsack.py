...
########################################
# Data class to hold an item.
# Contains a weight and value for the
# item.
########################################
...
########################################
# Class full of Items to 'steal' from
# with a knapsack. findMaxValue() is 
# my implementation of the knapsack
# problem
########################################
